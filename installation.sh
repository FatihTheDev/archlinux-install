...
configure_zram_swap() {
    dialog --infobox "Configuring zram-generator and disabling zswap..." 5 50

    # 1. Install zram-generator inside the new system
...
EOF
    ...
    # 3. Disable zswap permanently via modprobe and kernel parameter
